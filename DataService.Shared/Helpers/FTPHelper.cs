...
namespace DataService.Shared.Helpers
{
    ...
    public class FTPHelper
    {
        ...
        public FTPHelper(string FtpServerIP, string FtpPort, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
        ...
        public void MakeDir(string dirName)
        {
            ...
            {
                LogHelper.Log(LogLevel.Error, "创建文件夹失败!", ex);
            }
        }
        ...
        public long GetFileSize(string filename)
        {
            ...
            {
                LogHelper.Log(LogLevel.Error, "获取指定文件大小失败!", ex);
            }
            return fileSize;
        }
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            {
                LogHelper.Log(LogLevel.Error, "更改文件名失败!", ex);
            }
        }
